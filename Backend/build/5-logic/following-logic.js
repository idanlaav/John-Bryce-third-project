...
function getOneFollowById(id) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, values, followers, follower;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = "SELECT FollowerID AS followerId,\n                 UserID as userId,\n                 VacationID as vacationId\n                 FROM followers\n                 WHERE FollowerID = ?";
...
function addFollower(follower) {
    return __awaiter(this, void 0, void 0, function () {
        var errors, sql, values, result, addedFollow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sql = "INSERT INTO followers VALUES(DEFAULT, ?, ?)";
                    values = [follower.userId, follower.vacationId];
                    return [4 /*yield*/, dal_1.default.execute(sql, values)];
                case 1:
                    result = _a.sent();
                    follower.followerId = result.insertId;
                    return [4 /*yield*/, getOneFollowById(follower.followerId)];
                case 2:
                    addedFollow = _a.sent();
                    socket_logic_1.default.reportAddFollow(addedFollow);
                    return [2 /*return*/, addedFollow];
            }
        });
    });
}
// this function do that and return that
function deleteFollowFromVacation(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    socket_logic_1.default.reportDeleteFollow(id);
...
exports.default = {
    ...
    deleteFollowFromVacation: deleteFollowFromVacation,
